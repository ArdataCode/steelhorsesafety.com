...
if ( ! class_exists( 'PortoBuildersType' ) ) :
	class PortoBuildersType {
		...
		public function add_wpb_element() {
			...
			add_filter( 'vc_autocomplete_porto_tb_posts_terms_callback', array( $this, 'shortcode_posts_grid_callback' ), 10, 1 );
			add_filter( 'vc_autocomplete_porto_tb_posts_terms_render', array( $this, 'shortcode_posts_grid_render' ), 10, 1 );
		}
		/**
		 * Get suggestion
		 ...
		 * @since 6.11.0
		 */
		public function shortcode_posts_grid_callback( $query ) {
			$return = array();
		 ...
		 * @since 6.11.0
		 */
		public function shortcode_posts_grid_render( $query ) {
